...
#define SERIES_LENGTH 100  //Size of data buffer
...
int main(void)
{
    ...
    fRadians = ((2 * M_PI) / SERIES_LENGTH); // 100 segments to make 2pi

    while(i32DataCount < SERIES_LENGTH)  // iterate until count reaches 100 or 2pi
    {
        // Get sin from 0 to 2 pi in 100 counts and save all values in array. This array will
        // be viewed in memory
